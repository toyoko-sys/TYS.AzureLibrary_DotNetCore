...
namespace TYS.AzureLibrary
{
    ...
    public class OperateBlobStorage
    {
        ...
        /// <returns></returns>
        public static async Task<List<string>> SearchBlobNameAsync(CloudStorageAccount storageAccount, string containerName, string prefix)
        {
            // blobコンテナへの参照を取得する
            var container = GetContainerReference(storageAccount, containerName);
        ...
        /// <remarks>
        /// </remarks>
        public static async Task<bool> DeleteAsync(CloudStorageAccount storageAccount, string containerName, string blobName)
        {
            // blobコンテナへの参照を取得する
            var container = GetContainerReference(storageAccount, containerName);
